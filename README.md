...
Work in aviation and need quick answers
...
Caches search indexes (100x faster on repeat queries)
...
Result: Went from 20 seconds to 5.9 seconds average!
...
Subsequent queries should be around 6 seconds
If consistently over 10 seconds, reduce TOP_K_RETRIEVAL to 3

Running out of memory on Streamlit Cloud?

Split large PDFs into smaller files (under 25MB each)
...
Built with care by someone tired of searching through 500-page PDFs
